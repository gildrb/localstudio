...
Repo automation lives in `frontend/desktop/project/*.mjs` as plain readable modules; `scripts/project.mjs` (a symlink to `frontend/desktop/project.mjs`) only dispatches. Edit the module, not the entry.
